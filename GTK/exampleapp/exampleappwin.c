...
static void search_text_changed(GtkEntry *entry)
{
  ...
  win = EXAMPLE_APP_WINDOW(gtk_widget_get_toplevel(
    GTK_WIDGET(entry)));
...
static void find_word(GtkButton *button, ExampleAppWindow 
  *win)
{
  ExampleAppWindowPrivate *priv;
  const gchar *word;
...
static void update_words(ExampleAppWindow *win)
{
  ...
  strings = g_hash_table_new_full(g_str_hash, g_str_equal, 
    g_free, NULL);
  ...
  while(!gtk_text_iter_is_end(&start))
  {
    ...
    word = gtk_text_buffer_get_text(buffer, &start, &end, 
      FALSE);
    ...
    {
      gtk_container_remove(GTK_CONTAINER(priv->words), 
        GTK_WIDGET(l->data));
    }
      ...
      NULL))
    {
      ...
      g_signal_connect(row, "clicked", G_CALLBACK(
        find_word), win);
      gtk_widget_show(row);
...
static void update_lines(ExampleAppWindow *win)
{
  ExampleAppWindowPrivate *priv;
  GtkWidget *tab, *view;
  GtkTextBuffer *buffer;
...
static void visible_child_changed(GObject *stack, 
  GParamSpec *pspec)
{
  ExampleAppWindow *win;
  ExampleAppWindowPrivate *priv;
  ...
  win = EXAMPLE_APP_WINDOW(gtk_widget_get_toplevel(
    GTK_WIDGET(stack)));
  priv = example_app_window_get_instance_private(win);
  gtk_search_bar_set_search_mode(GTK_SEARCH_BAR(priv
    ->searchbar), FALSE);
  update_words(win);
  update_lines(win);
}
...
static void words_changed(GObject *sidebar, 
  GParamSpec *pspec, ExampleAppWindow *win)
{
  update_words(win);
}
...
static void example_app_window_dispose(GObject *object)
{
  ...
  G_OBJECT_CLASS(example_app_window_parent_class)->dispose(
    object);
}
...
static void example_app_window_class_init(ExampleAppWindowClass *class)
{
  ...
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, search);
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, searchbar);
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, 
    searchentry);
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, gears);
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, words);
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, words);
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, sidebar);
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, lines);
  gtk_widget_class_bind_template_child_private(
    GTK_WIDGET_CLASS(class), ExampleAppWindow, 
    lines_label);
