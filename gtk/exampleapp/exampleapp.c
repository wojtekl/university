...
{
  { "preferences", preferences_activated, NULL, NULL, 
    NULL }, 
...
static void example_app_startup(GApplication *app)
{
  ...
  G_APPLICATION_CLASS(example_app_parent_class)->
    startup(app);
  ...
  builder = gtk_builder_new_from_resource(
    "/org/gtk/exampleapp/app-menu.ui");
  app_menu = G_MENU_MODEL(gtk_builder_get_object(builder, 
    "appmenu"));
